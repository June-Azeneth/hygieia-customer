...
class TransactionDetailsDialog(
    ...
    private lateinit var transactionRepo: TransactionsRepo
    ...
    private fun setUpUi() {
        ...
        if (transaction.type == "redeem") {
            totalPoints.text = Commons().formatDecimalNumber(transaction.pointsSpent)
            ...
            pointsGranted.text = Commons().formatDecimalNumber(transaction.pointsEarned)
        }
    }
